...
- Start the requested provider in that pane, send the complete worker contract, wait
  on agent status/output with bounded timeouts, and capture output before cleanup.
